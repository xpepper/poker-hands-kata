...
public class GameRunnerTest {
    ...
    public void white_wins_with_high_card() {
        String gameResult = gameRunner.run("Black: 2H 4D  White: 2C 5H");

        assertEquals("White wins. - with high card: 5", gameResult);
    }

    @Test
    public void black_wins_with_high_card() {
        String gameResult = gameRunner.run("Black: 2C 5H  White: 2H 4D");
    ...
    public void when_no_player_has_a_winning_hand_the_game_is_tie() {
        String gameResult = gameRunner.run("Black: 2H 5D  White: 2C 5H");
